...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
  out_1, fc_cache = affine_forward(x, w, b)
  out_2, bn_cache = batchnorm_forward(out_1, gamma, beta, bn_param)
  out, relu_cache = relu_forward(out_2)
...
def affine_ln_relu_forward(x, w, b, gamma, beta, ln_param):
  out_1, fc_cache = affine_forward(x, w, b)
  out_2, ln_cache = layernorm_forward(out_1, gamma, beta, ln_param)
  out, relu_cache = relu_forward(out_2)
